...
const BACKDROP_COLLECTION_DETAIL =
  "https://images.unsplash.com/photo-1560448204-61d461b5e16b?auto=format&fit=crop&w=1600&q=65";
...
export default async function CollectionDetailPage({ params }: PageProps) {
  ...
  return (
    <main className="bg-background pb-24">
      <InnerPageHeader backdropSrc={BACKDROP_COLLECTION_DETAIL} parallaxStrength={0.4}>
          ...
          {collection.products.map((product, index) => {
            ...
            return (
              <Reveal key={product.slug} delayMs={index * 60}>
                <article className="flex h-full flex-col overflow-hidden rounded-sm border border-foreground/10 bg-background shadow-[0px_32px_60px_-50px_rgb(43_42_41)]">
